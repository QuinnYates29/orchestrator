"""Command-line interface for pipeline.review.
...
from pipeline.review.checks import DEFAULT_MAX_LINE_LENGTH, registry, run_checks
from pipeline.review.diff import collect_diff, parse_diff
from pipeline.review.report import format_json, format_text
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"review: could not read the diff: {e}", file=sys.stderr)
        return 2
