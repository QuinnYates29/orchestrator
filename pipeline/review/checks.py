"""The checks the review pipeline runs over the added lines of a diff.
...
from pipeline.review.languages import Language, Line, build_lines, detect
from pipeline.review.models import FileDiff, Finding, Review, Severity
